  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        brand: { cyan: "#27D7FF", orange: "#FF7A1A", navy: "#050B14", card: "#0A1E33" },
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 2px)", sm: "calc(var(--radius) - 4px)" },
      boxShadow: {
        xs: "0 1px 2px 0 rgba(0,0,0,0.05)",
        "glow-cyan": "0 0 20px rgba(39,215,255,0.4), 0 0 40px rgba(39,215,255,0.2)",
        "glow-orange": "0 0 20px rgba(255,122,26,0.5), 0 0 40px rgba(255,122,26,0.25)",
      },
      keyframes: {
